...
Route::group(['prefix'=>'admin', 'namespace'=>'Admin', 'middleware'=>['revalidate', 'auth']], function($route){
	...
	$route->delete('for_kpj_link_delete_selected', 'FindDoctorController@DeleteSelectedlinkList');
	...
	$route->delete('room_rate',['as'=>'admin.room_rate.destroy', 'uses'=>'RoomRateController@destroy']);
        $route->delete('room_rate/{id}',['as'=>'admin.room_rate.destroys', 'uses'=>'RoomRateController@destroys']);
