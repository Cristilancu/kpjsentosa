...
class VisitorController extends Controller
{
   ...
   public function DeleteSelectedVisitorList(Request $request)
   {
    ...
    public function getGeneralDescription($id)
    {
        ...
        return view('admin.patients.for_visitors_details_edit', compact(["visitor"]));
    ...
    public function postGeneralDescription(Request $request, $id)
    {
        ...
        $visitor = VisitorList::findOrFail($id);
        $visitor->desc = $request->general_desc;
        $visitor->save();

        $date = date('d M, Y @ h:i a', strtotime($visitor->updated_at));
