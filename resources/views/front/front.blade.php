            	...
            	<div class="col-md-3">
                	...
                	<div class="footer-widget">
						...
						<form name="newsletter_form" id="newsletter_form" method="post" action="/subscribe" onSubmit="return ">
                            <input type="text" name="name" id="news_name" placeholder="Your Name" onKeyPress="removeChecks();" required="">
                            <input type="email" name="email" id="news_email_address" placeholder="Email Address" onKeyPress="removeChecks();" required="">
