...
@section('content')
    ...
    <div class="alert alert-danger alert-dismissable">
    	...
    	<h2 class="text-center error_message"><i class="fa fa-exclamation-triangle"></i><strong>&nbsp; Error!</strong></h2>
			<h3 class="light text-center error_message">Oops! Your account hasn't been created yet. Please check and correct the errors below.</h3>
    </div>
      <div class="alert alert-danger alert-dismissable">
            <button type="button" data-dismiss="alert" aria-hidden="true" class="close">&times;</button>
      <ul>
    ...
    <div class="row">
    	<div class="col-md-12">
    		<div class="alert alert-success">
    			<h2 class="text-center"><i class="fa fa-check-circle"></i><strong>&nbsp; {{ session()->get('message') }} </strong></h2>
    			<h3 class="light text-center">Thank You for your registration. </h3>
    		</div>
    	</div>
    </div>
	@endif
    ...
    <!-- <div class="row">
    	<div class="col-md-12">
            ...
            <div class="alert alert-success">
            	<h2 class="text-center"><i class="fa fa-check-circle"></i><strong>&nbsp; Your Appointment Reference #: kpj-0000000001</strong></h2>
