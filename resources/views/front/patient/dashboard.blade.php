                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <h5>Welcome back! {{\Auth::user()->patient->first_name}},</h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <a href="/patient/appointment/{{$appointment->id}}/details" data-hover="tooltip" data-placement="top" title="View Details">
                                ...
                                <div class="tool-footer text-center">
                                   <a href="{{ url("patient/appointment") }}"><input type="submit" class="btn btn-sm btn-danger btn-rounded" value="View All Appointments"></a>
