							...
							<div class="panel-group" id="accordion">
								  ...
								  <div class="panel-body">
                                      @foreach($rooms as $room)
                                          ...
                                          <ul class="list-unstyled pricing-table">
                                              ...
                                              @foreach($room->room_details as $detail)
                                                  <li class="list-dark">
                                                      <span>{{$detail->wards}}</span>
                                                      <span>
                                            	<p>{{$detail->facilities}}</p>
         									</span>
                                                      <span class="text-right">{{$detail->rates_day}}</span>
                                                  </li>
                                              @endforeach
							  ...
							  <div class="panel panel-default">
								...
								<div id="collapseThree" class="panel-collapse collapse">
								  <div class="panel-body">
									{!! $admissionDepositBanner->admission_desc !!}
                                    ...
                                    <ul class="list-unstyled pricing-table">
                                        ...
                                        @foreach($admissionDeposits as $admissionDeposit)
                                        <li class="list-dark">
                                            <span>{{$admissionDeposit->case_type}}</span>
                                            <span class="text-right">{{$admissionDeposit->initial_deposit}}</span>
                                        </li>
                                        @endforeach
                                       <!--  <li class="list-light">
                                            <span>ICU Cases</span>
                        ...
                        <div class="panel-group" id="accordion-visitor">
                            ...
                            @foreach($visitors as $key=>$visitor)
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title active">
                                            <a data-toggle="collapse" data-parent="accordion-visitor" href="#collapse{{$key+4}}">
                                                <span><i class="fa @if($key==0)fa-plus @endif fa-minus"></i></span><h4>{{ $visitor->title }}</h4>
                                            </a>
                                        </h4>
                                    </div>

                                    <div id="collapse{{$key+4}}" class="panel-collapse collapse @if($key==0)in @endif">
                                        <div class="panel-body">
                                            {!! $visitor->desc !!}
                                        </div>
                                    </div>
