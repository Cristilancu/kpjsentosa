...
@section('content')
	...
	<div class="page-header-breadcrumb">
		...
		<ol class="breadcrumb page-breadcrumb text-center">
			...
			@if($patient)
				<li><a href="/patient/dashboard">You are logged in as: {{$patient->first_name}} {{$patient->last_name}}</a></li>
			@else
	...
	<form class="form-horizontal" method="post" action="/book-appointment">
		...
		<div class="col-md-6">
			...
			<div class="height10"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static">{{$patient->mrn_number}}</p>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static">{{$patient->last_name}}</p>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static">{{$patient->date_of_birth}}</p>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static">{{ucwords($patient->gender)}}</p>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static">{{$patient->passport_number}}</p>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static">{{$patient->contact_number}}</p>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<p class="form-control-static">{{$patient->user->email}}</p>
					</div>
				</div>
				<div class="clearfix"></div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<p class="form-control-static">{{$patient->postal_code}}</p>
			</div>
		</div>
		<div class="clearfix"></div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<p class="form-control-static">{{$patient->state}}</p>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<p class="form-control-static">{{$patient->country->name}}</p>
			</div>
		</div>
		<div class="clearfix"></div>
