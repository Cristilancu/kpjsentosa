...
@section('content')
	...
	<div class="col-md-6">
	Appointment Date: <h5>{{ date("d F, Y", strtotime($appointment->appointment_date)) }} ({{$appointment->appointment_day}})
	</h5>
		...
		<div class="col-md-6">
			...
			<div class="height10"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" name="passsport_number" value="{{old('passport_number')}}">
					</div>
				</div>
				<div class="clearfix"></div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				<select class="form-control" name="country_id">
					...
					<option value="{{$country->id}}" data-calling-code="{{$country->calling_code}}" data-eu-tax="{{$country->eu_tax}}" {{(old('country_id')==$country->id?'selected="selected"':'')}} <?php if($country->name=='Malaysia'){ echo 'selected'; } ?> >{{$country->name}}</option>
					@endforeach
				</select>
			</div>
		</div>
