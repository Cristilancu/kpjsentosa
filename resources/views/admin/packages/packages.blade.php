...
@section('title')
<title>Promotion Packages:: Listing</title>
  @stop
  ...
  <div id="page-wrapper"><!--BEGIN PAGE HEADER & BREADCRUMB-->
        ...
        <div class="page-header-breadcrumb">
          <div class="page-heading hidden-xs">
            <h1 class="page-title">Promotions</h1> </div>
          ...
          <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="active">Promotion Packages - Listing</li>
          </ol>
        ...
        <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Promotion &amp; Packages <i class="fa fa-angle-right"></i> Listing</h2>
                ...
                <div class="portlet-body"> note to programmer: the heading text and sub heading text below should follow the css style 100% in front end.
                  <div contenteditable="true" id='line1'>
                   @if($setting = Helper::hasSetting('packages'))
                        {!!$setting->line1!!}
                    @else  
                      <h1 class="entry-title">Promotion Packages</h1>
                    @endif
                  </div>
                </div>
              </div>
                    ...
                    <div class="modal-dialog modal-wide-width">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form">
                            <form class="form-horizontal" action="/admin/promotion_packages/add" method="post" onsubmit="return getContent('details', 'det')" enctype="multipart/form-data" >
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input type="text" class="form-control" placeholder="eg. Wellness promotion Package 1" name='title' required="">
                                </div>
                              </div>
                              <div class="clearfix"></div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <textarea name="description" rows="2" class="form-control" placeholder="eg. General Executive promotion 1 by Wellness Doctor (MO)" required=""></textarea>
                                </div>
                              </div>
                              <div class="clearfix"></div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <input type="text" class="form-control" name="alt" placeholder="eg. Wellness promotion Package 1">
                                </div>
                              </div>
                              <div class="clearfix"></div>
                                ...
                                <div class="col-md-9"> 
                                 ...
                                 <input type="hidden" name="details" id='det'>
                                  <div contenteditable="true" id='details'>
                                    <h5>Be proactive and get checked!</h5>
                                        <p>If you are having any of these symptoms:</p>
                                        <ul class="list-unstyled">  
                                            <li><i class="fa fa-check"></i> Difficulty to pass urine </li>
                                            <li><i class="fa fa-check"></i> Frequent or painful urination</li>
                                            <li><i class="fa fa-check"></i> Blood in the urine</li>
                                            <li><i class="fa fa-check"></i> Frequent passing of urine at night (Nocturia)</li>
                                            
                                        </ul>
                                        <h5>Package Details:</h5>
                                        <ul class="list-unstyled">  
                                            <li><i class="fa fa-check"></i> Consultation &amp; Examination by Consultant Urologist</li>
                                            <li><i class="fa fa-check"></i> Ultrasound Kidney &amp; Bladder</li>
                                            <li><i class="fa fa-check"></i> Uroflow Test</li>
                                            <li><i class="fa fa-check"></i> PSA Blood Test</li>
                                            <li><i class="fa fa-check"></i> Urine FEME</li>
                                        </ul>
                                        <p>For enquiries and appointments, please call (03) 4043-7166 ext.113/114 (Ms Janaki) or email to <a href="mailto:kpjsentosa@kpjsentosa.com">kpjsentosa@kpjsentosa.com</a></p>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8"> <a href='javascript:void(0)' class="btn btn-red all_del" val='promotion_package'>Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href='javascript:void(0)' data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div id="modal-delete-all" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8"> <a href="/admin/action_delete/all/promotion_packages" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href='javascript:void(0)' data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                                ...
                                <div id="modal-edit-package-{{$pack->id}}" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                  <div class="modal-dialog modal-wide-width">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="form">
                                          <form class="form-horizontal" method="post" action="/admin/promotion_packages/{{$pack->id}}/edit" enctype="multipart/form-data" onsubmit="getContent('de_{{$pack->id}}', 'de_t_{{$pack->id}}')">
                                            <div class="form-group">
                                              <label class="col-md-3 control-label">Status</label>
                                              <div class="col-md-9">
                                                <div data-on="success" data-off="primary" class="make-switch">
                                            ...
                                            <div class="form-group">
                                              <label class="col-md-3 control-label">Package Title <span class='require'>*</span></label>
                                              <div class="col-md-9">
                                               <input type="text" class="form-control" name="title" placeholder="eg. Wellness promotion Package 1" value="{{$pack->title}}" required="">
                                              </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            ...
                                            <div class="form-group">
                                              <label class="col-md-3 control-label">Short Description <span class='require'>*</span></label>
                                              <div class="col-md-9">
                                                <textarea name="description" rows="2" class="form-control" placeholder="General Executive promotion 1 by Wellness Doctor (MO)" required="">{{$pack->description}}</textarea>
                                              </div>
                                            </div>
                                            <div class="clearfix"></div>
                                                              ...
                                                              <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-body">
                                                                    ...
                                                                    <div class="form-actions">
                                                                      <div class="col-md-offset-4 col-md-8"> <a href='javascript:void(0)' class="btn btn-red del_item" type='image' model='promotion_package' input='image_{{$pack->id}}' hide_div='del_item_image_{{$pack->id}}' model_id='{{$pack->id}}'> Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href='javascript:void(0)' data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                                    </div>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                        ...
                                                        <div class="modal-dialog">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              ...
                                                              <div class="form-actions">
                                                                <div class="col-md-offset-4 col-md-8"> <a href='javascript:void(0)' class="btn btn-red  del_item" type='image_large' model='promotion_package' input='image_large_{{$pack->id}}' hide_div='del_item_image_large_{{$pack->id}}' model_id='{{$pack->id}}' >Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href='javascript:void(0)' data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      ...
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            ...
                                                            <div class="form-actions">
                                                              <div class="col-md-offset-4 col-md-8"> <a href='javascript:void(0)' class="btn btn-red del_item" type='pdf' model='promotion_package' input='pdf_{{$pack->id}}' hide_div='del_item_pdf_{{$pack->id}}' model_id='{{$pack->id}}' >Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href='javascript:void(0)' data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9"> 
                                                  <p class="text-blue text-12px margin-top-15px border-bottom">You can edit the content by clicking the text section below.</p>
                                                  <input type="hidden" name="details" id='de_t_{{$pack->id}}'>
                                                  <div contenteditable="true" id='de_{{$pack->id}}' >
                                                      {!!$pack->details!!}
                                                    </div><!-- end contenteditable -->
                                ...
                                <div id="modal-delete-{{$pack->id}}" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <p><strong>#{{$key+1}}:</strong> {{$pack->title}}</p>
                                        <div class="form-actions">
                                          <div class="col-md-offset-4 col-md-8"> <a href='/admin/action_delete/{{$pack->id}}/promotion_package' class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href='javascript:void(0)' data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
