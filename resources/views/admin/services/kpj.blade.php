          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#kpj-advisor-series-category-setup" data-toggle="tab">KPJ Advisor Series Category Setup</a></li>
                <li><a href="#parallax-bg-text" data-toggle="tab">Parallax Background &amp; Text</a></li>
              </ul>
              
              <div id="myTabContent" class="tab-content">
              
              	<div id="kpj-advisor-series-category-setup" class="tab-pane fade in active">
                        ...
                        <div class="portlet-body">
                          ...
                          <div class="table-responsive mtl">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><input type="checkbox" class="del" val="{{$cat->id}}"/></td>
                                <td>{{$key+1}}</td>
                                <td> 
                             @if($cat && $cat->status)
                          ...
                          <div class="table-responsive">
                              <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td><input type="checkbox" class="del_kpj" val='{{$cat->id}}' /></td>
                                    <td>{{$key+1}}</td>
                                    <td>@if($cat->status)
                              <span class="label label-xs label-success">Active</span></td>
                              @else
                                                  ...
                                                  <form class="form-horizontal" action="/admin/kpjs/{{$cat->id}}/ed" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                          ...
                                                          @foreach(Helper::getCategories() as $cp)
                                                    ...
                                                    <div class="del_item_div_{{$cat->id}}">
                                                            <a href="{{$cat->pdf}}" target="_blank">{{$cat->formated_time}}</a><br/>
                                                              ...
                                                              <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-body">
                                                                    <p>{{$cat->pdf}}</p>
                                                                    <div class="form-actions">
                                                                      <div class="col-md-offset-4 col-md-8"> <a href='javascript:void(0)' class="btn btn-red del_item" type='image' model='event' input='pdf_{{$cat->id}}' hide_div='del_item_div_{{$cat->id}}' model_id='{{$cat->id}}'>Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href='javascript:void(0)' data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                                    </div>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                          ...
                                                          <!-- modal delete end -->
                                                            <div class="xs-margin"></div>
                                                          <div class="text-15px margin-top-10px">
                                                              <input id="pdf_{{$cat->id}}" type="file" name="pdf"  accept=".pdf" />
                                                            </div>
                                                        </div>
                                                      </div>
                                                      <div class="form-group">
