                ...
                <div class="portlet-header">
                  ...
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      {{--<li><a href="javascript:void(0)" data-target="#modal-delete-selected"  val='index_banner' id="modal-delete-selected-btn">Delete selected item(s)</a></li>--}}
                      ...
                      {{--<li><a href="javascript:void(0)" data-target="#modal-delete-all" val='index_banner' id="modal-delete-selected-btn-all">Delete all</a></li>--}}
                    </ul>
                  </div>
                   
<div class="tools"> <i class="fa fa-chevron-up"></i> </div>
                  <!--Modal Add New Banner start-->
                  <div id="modal-add-new" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                  ...
                  <div id="modal-delete-selected" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal index-banner-del-modal fade">
                ...
                <div class="portlet-body">
                  ...
                  <div class="table-responsive mtl">
                    <table class="table table-hover table-striped" id="index-banner">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                      <?php $i = $indexes->perPage() * ($indexes->currentPage()-1);?>
                @foreach($indexes as $key=>$id)
                        <tr>
                          ...
                          <td><a href="javascript:void(0)" data-hover="tooltip" data-placement="top" data-target="#modal-edit-banner-{{$id->id}}" data-toggle="modal" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="javascript:void(0)" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-{{$id->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                              ...
                              <div id="modal-edit-banner-{{$id->id}}" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                <div class="modal-dialog modal-wide-width">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="del_item_div_{{$id->id}}">
                                              <div class="text-15px margin-top-10px"> <img src="{{$id->image}}" alt="Care for Life" class="img-responsive"><br/>
                                                  ...
                                                  <!--Modal delete start-->
                                                  <div id="modal-delete-image-{{$id->id}}" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        <div class="modal-header">
                                                          <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                      ...
                                      <div class="form-group">
                                             ...
                                             @if($id->align=='left' && $id->image_2)
                                              <div class="del_item_div_icon_{{$id->id}}">
                                                  ...
                                                  <div id="modal-delete-icon-{{$id->id}}" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        <div class="modal-header">
                                                          <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                            ...
                            <!--END MODAL Edit Montage-->
                              <!--Modal delete start-->
                              <div id="modal-delete-{{$id->id}}" question_quiz role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                    ...
                    <div class="row">
                      <div class="col-md-5 col-sm-12">
                        <div class="dataTables_info">
                          &nbsp;Showing {{ $indexes->firstItem() }} - {{ $indexes->lastItem() }} of {{ $indexes->total() }} entries
                        </div>
                      </div>
                      <div class="col-md-7 col-sm-12">
                        <div class="paging_bootstrap pull-right">

                            <?php echo $indexes->render()?>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix"></div>
  ...
  @section('end_scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#index-banner_info').add('.dataTables_paginate').add('#index-banner_length').hide();
        })
    </script>
  @stop
