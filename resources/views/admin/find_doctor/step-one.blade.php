				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label class="col-md-4">Email (Login ID): <span class="text-danger">*</span></label>
							<div class="col-md-8">
								<input type="text" class="form-control" placeholder="eg. mail@yourdomain.com" required>
							</div>
						</div>
						<div class="clearfix"></div>
										...
										<div class="col-md-12">
											<h4>Please select a time slot:
												...
												<input type="radio" data-index="{{ $index }}" name="schedule_id"
															 ...
															 {{ $index == 0 ? 'checked required' : '' }} /> <div style="margin-left: 35px; margin-top: -20px; line-height: 1.42">{{ str_replace(": ", "", $schedule) }}</div>
												@endforeach
											</h4>
