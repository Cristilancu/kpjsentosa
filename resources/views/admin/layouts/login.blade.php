...
<link type="text/css" rel="stylesheet" href="/admin_html/css/style-responsive.css">
...
<script srd="/admin_html/js/jquery-1.9.1.js"></script>
<script srd="/admin_html/js/jquery-migrate-1.2.1.min.js"></script>
<script srd="/admin_html/js/jquery-ui.js"></script>
<!--loading bootstrap js-->
<script src="vendors/bootstrap/js/bootstrap.min.js"></script>
<script src="vendors/bootstrap-hover-dropdown.js"></script>
<script srd="/admin_html/js/html5shiv.js"></script>
<script srd="/admin_html/js/respond.min.js"></script>
