<div id="modal-edit-patient-{{$patient->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
    <div class="modal-dialog modal-wide-width">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                <h4 id="modal-login-label3" class="modal-title">For Patients - Edit</h4>
            </div>
            <div class="modal-body">
                <div class="form">
                    <form class="form-horizontal" action="{{ url('/admin/for_patients_edit', $patient->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" class="form-control" placeholder="eg. Room Rates" value="{{ $patient->title }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                placeholder="eg. Our facilities and services at KPJ Sentosa KL Specialist Hospital are among the best and most modern to serve your needs more effectively.">{{$patient->short_desc}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <img src="../images/Patients&VisitorLists/{{$patient->image_path}}" alt="Room Rates" class="img-responsive bg-default"><br/>
                                ...
                                <input type="hidden" name="image_path_status" value="{{ $patient->image_path }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="image_alt" class="form-control" placeholder="eg. Room Rates" value="{{$patient->image_alt}}">
                            </div>
                        </div>
