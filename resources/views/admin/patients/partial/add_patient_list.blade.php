    ...
    <div class="modal-dialog modal-wide-width">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form">
                    <form class="form-horizontal" action="{{ url('/admin/for_patients_details_new') }}" method="POST"  id="modal-add-patient" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" class="form-control" placeholder="eg. Room Rates" value="{{ old('title') }}">
                            </div>
                        </div>
                        <div class="form-group">
