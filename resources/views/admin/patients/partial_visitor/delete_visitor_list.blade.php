<div id="modal-delete-{{$visitor->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/admin/for_visitors_details_delete', $visitor->id) }}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <p><strong>#{{$visitor->id}}:</strong> {{ $visitor->title }}</p>
