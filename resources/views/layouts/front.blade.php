...
<footer id="footer" class="light">
		...
		<!-- Copyright
		============================================= -->
		@foreach(Helper::copyright() as $link)
        <span class="copyright text-center"><?php echo htmlspecialchars_decode($link->details); ?></span>
        @endforeach
		...
		<div class="container">
        	<div class="row">
            	...
            	<div class="col-md-12">
				   @foreach(Helper::privacyPolicy() as $link)
                	<span class="footer-bottom-text text-center"><?php echo htmlspecialchars_decode($link->details); ?></span>
				   @endforeach
                </div>
            </div>
        </div>
