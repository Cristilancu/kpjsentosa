...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,300italic,700' rel='stylesheet'
          type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Merriweather:400,300,400italic,700,700italic,300italic'
          rel='stylesheet' type='text/css'>

    <link type="text/css" rel="stylesheet"
          href="/admin_html/vendors/jquery-ui-1.10.3.custom/css/ui-lightness/jquery-ui-1.10.3.custom.css">
    ...
    <div id="wrapper"><!--BEGIN TOPBAR-->
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" class="navbar navbar-default navbar-static-top">
            <div class="navbar-header">
                ...
                <a id="logo" href="http://www.webqom.com/web88.html" target="_blank" class="navbar-brand"><img
                            src="/admin_html/images/logo_web88.png"></a></div>

            <div class="topbar-main">
                <a id="logo" href="http://kpjsentosa.com/" class="navbar-brand" target="_blank"><img
                            src="/admin_html/images/logo.jpg"></a>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown"><a data-toggle="dropdown" href="#" class="dropdown-toggle"><img
                                    src="{{@Auth::user()->image?Auth::user()->image:'/admin_html/images/profile/image_hock.jpg'}}"
                            ...
                            <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-xs-5"><img
                                            ...
                                            <p class="text-center mtm">
                                                <a href="#" data-target="#modal-change-avatar" data-toggle="modal"
                                                   class="change-avatar">
                                ...
                                <div class="navbar-footer">
                                    <div class="navbar-footer-content">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-6"><a href="#" class="btn btn-default btn-sm"
        ...
        <!--Modal Change Avatar start-->
        <div id="modal-change-avatar" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true"
             class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form">
                            <form class="form-horizontal" action="/admin/change_avatar" enctype="multipart/form-data"
                                  method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-15px margin-top-10px">
                                            <img src="{{@Auth::user()->image?Auth::user()->image:'/admin_html/images/profile/image_hock.jpg'}}"
                                                 alt="Avatar" class="img-responsive"><br/>
        ...
        <div id="modal-change-password" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
             aria-hidden="true" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                        <h4 id="modal-login-label" class="modal-title"><a href="#"><i
                                        class="fa fa-exclamation-triangle"></i></a> Change Password</h4></div>
                    <div class="modal-body">
                        <div class="form">
                            <form class="form-horizontal" action="/admin/change_password" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-icon"><i class="fa fa-key"></i> <input id="password"
                                                                                                 ...
                                                                                                 class="form-control"
                                                                                                 name="password"/><span
                                                    class="text-10px">(Password length should be between 6-12 characters)</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-icon"><i class="fa fa-key"></i> <input
                                                    id="password_confirmation" type="password"
                                                    placeholder="Confirm New Password" class="form-control"
                                                    name="old_password"/><span class="text-10px">(Password length should be between 6-12 characters)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-actions">
        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'home'))
                    <li class="sidebar-heading"><h4>Main Menu</h4></li>
                    <li class=" lem lem_dashboard"><a href="/admin/dashboard"> <!-- home -->
                            <i class="fa fa-laptop fa-fw"></i><span class="menu-title">Dashboard</span></a></li>

                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'contact_us'))

                    <li class="sidebar-heading"><h4>Contacts</h4></li> <!--  Contact us -->
                    <li class="lem lem_contact"><a href="/admin/feedback_list"><i class="fa fa-coffee fa-fw"></i><span
                                    class="menu-title">Feedback Listing</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'screening_packages'))

                    <li class="sidebar-heading"><h4>Promotions</h4></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'screening_packages'))   <!-- Screening & Packages -->

                        <li class="lem lem_screening"><a href="/admin/screening_packages_list/"><i
                                        class="fa fa-viadeo-square fa-fw"></i><span class="menu-title">Screening &amp; Packages</span></a>
                        </li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                        <li class="lem lem_promotion"><a href="/admin/promotion_packages_list/"><i
                                        class="fa fa-qrcode fa-fw"></i><span
                                        class="menu-title">Promotion Packages</span></a></li>

                        <li class="lem lem_newsletter"><a href="/admin/newsletter"><i class="fa fa-envelope fa-fw"></i><span
                                        class="menu-title">Newsletter Subscription</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                        <li class="sidebar-heading"><h4>News &amp; Events</h4></li>

                        <li class="lem lem_latest"><a href="/admin/latest_news"><i class="fa fa-newspaper-o fa-fw"></i><span
                                        class="menu-title">Latest News</span></a></li>

                        <li class="lem lem_events"><a href="/admin/latest_events_list"><i
                                        class="fa fa-calendar fa-fw"></i><span class="menu-title">Events</span></a></li>

                        <li class="lem lem_health"><a href="/admin/health_calendar_list"><i
                                        class="fa fa-calendar-plus-o fa-fw"></i><span
                                        class="menu-title">Health Calendar</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                    <li class="sidebar-heading"><h4>Banners</h4></li>
                    <li class="lem lem_banners"><a href="/admin/index_banner_list"><i
                                    class="fa fa-check-circle fa-fw"></i><span
                                    class="menu-title">Index Banners</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'patients_visitors') || \Auth::user()->hasPermission(\Auth::user(), 'services_procedures'))
                        <li class="sidebar-heading"><h4>CMS Pages</h4></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                    <li class="lem lem_index"><a href="/admin/index_page"><i class="fa fa-check-circle fa-fw"></i><span
                                    class="menu-title">Index Page</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                    <li class="lem lem_vacancy lem_online"><a href="#"><i class="fa fa-briefcase fa-fw"></i><span
                                    class="menu-title">Careers</span><span class="fa arrow"></span></a>
                    ...
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'services_procedures')) <!-- Services &amp; Procedures -->

                    <li class="lem lem_services"><a href="/admin/services_procedures"><i
                                    class="fa fa-stethoscope fa-fw"></i><span class="menu-title">Services &amp; Procedures</span></a>
                    </li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                    <li class="lem lem_kpj"><a href="/admin/kpj_advisor_series_list"><i
                                    class="fa fa-h-square fa-fw"></i><span class="menu-title">KPJ Advisor Series</span></a>
                    </li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'patients_visitors')) <!-- Patients &amp; Visitor -->

                        <li class="lem lem_patients lem_visitors "><a href="/admin/patients_visitors_list"><i
                                    class="fa fa-plus-square fa-fw"></i><span
                                    class="menu-title">Patients &amp; Visitor</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'find_doctor') || \Auth::user()->hasPermission(\Auth::user(), 'consultant_appointments'))

                    <li class="sidebar-heading"><h4>Find Doctor</h4></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'find_doctor') ) <!--  Consultant Appointments and Find Doctor -->

                    <li class="lem lem_consultant"><a href="/admin/find_doctor_list"><i class="fa fa-user-md fa-fw"></i><span
                                    class="menu-title">Consultants Listing</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') || \Auth::user()->hasPermission(\Auth::user(), 'find_doctor') )

                    <li class="lem lem_patient"><a href="/admin/patients_list"><i class="fa fa-user fa-fw"></i><span
                                    class="menu-title">Patients Listing</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator') ||  \Auth::user()->hasPermission(\Auth::user(), 'consultant_appointments'))

                    <li class="lem lem_appointment"><a href="/admin/appointments_list"><i
                                    class="fa fa-calendar fa-fw"></i><span
                                    class="menu-title">Appointments Listing</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                    <li class="sidebar-heading"><h4>Menu</h4></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                    <li class="lem lem_navbar"><a href="/admin/categories_list"><i class="fa fa-check-circle fa-fw"></i><span
                                    class="menu-title">Menu Items Listing</span></a></li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))

                    <li class="sidebar-heading"><h4>User Control</h4></li>
                    <!-- InstanceBeginEditable name="EditRegion3" -->
                    <li class="lem lem_administrators_list">
                        <a href="/admin/access_listing">
                            <i class="fa fa-cog fa-fw"></i><span class="menu-title">Access Listing</span>
                        </a>
                    </li>
                    <li class="lem lem_user_group">
                        <a href="/admin/roles_setup">
                            <i class="fa fa-users fa-fw"></i><span class="menu-title">Roles Setup</span>
                        </a>
                    </li>
                    @endif
                    @if(\Auth::user()->hasRole('Super Administrator'))
                        ...
                        <li class="lem lem_footer"><a href="/admin/footer_setup"><i
                                        class="fa fa-check-circle fa-fw"></i><span
                                        class="menu-title">Footer Setup</span></a></li>
                    @endif
                </ul>
            </div>
        </nav>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="">
                            ...
                            @endfor
                            <form id='submit_preview' action="/admin/save_preview" method="post"
        ...
        <div class="page-footer">
            <div class="copyright"><span class="text-15px">2016 © <a href="http://www.webqom.com" target="_blank">Webqom Technologies Sdn Bhd.</a> Any queries, please contact <a
...
<?php if(Route::getCurrentRoute()->getPath()!='admin/find_doctor/{id}/edit'){ ?>
...
<script type="text/javascript">
    ...
    $('table').not(".datatable-exception").DataTable({
        "aoColumnDefs": [
        ...
        "fnInfoCallback": function (oSettings, iStart, iEnd, iMax, iTotal, sPre) {
            if ($(this).attr('id') == 'dtKpj') {
                array_del_kpj = [];
                $('.del_kpj').each(function (i, obj) {
...
<script type="text/javascript">
    ...
    $(document).on('click', '.del_kpj', function () {
        var val = $(this).attr('val');
        if (array_del_kpj.indexOf(val) != -1) {
            array_del_kpj.remove(val);
        } else {
            array_del_kpj.push(val);
        }
    ...
    $('.single_del').click(function () {
        ...
        console.log(array_del, model)

        $.ajax({
            url: '/admin/action_delete/' + id + '/' + model,
            data: {
                model: model,
                id: id
            },
...
<script type="text/javascript">
    ...
    //fixes issue with firefox that block the input in images upload dialog box
    ...
    $('.dropdown-menu li a ').click(function () {
        ...
        var _array_del = array_del;
        if (_target == '#modal-delete-selected-kpj') {
            console.log("change array del");
            _array_del = array_del_kpj;
        }

        if (_array_del.length < 1) {
            if (_target == '#modal-delete-selected-kpj') {
                var tp = $('.all_del_kpj').attr('val');
                console.log(tp);
                var four_txt = '';
                if ($('.all_del_kpj').attr('take_four') == 'yes') {
                    var four_txt = 'yes';
                }
                $('.all_del_kpj').parents('.form-actions').html("<div class='col-md-12'><div class='alert alert-danger'> Please select at least one item for delete.</div><span class='all_del_kpj' val='" + tp + "' take_four='" + four_txt + "'></span></div>");
            } else {
            ...
            $.each(_array_del, function (key, val) {
                if (_target == '#modal-delete-selected-kpj') {
                    var txt = $('.del_kpj[val=' + val + ']').closest('tr').children("td:nth-child(4)").html();
                    var cnt = $('.del_kpj[val=' + val + ']').closest('tr').children("td:nth-child(2)").html();
                    var fifth = '';
                    if ($('.all_del_kpj').attr('take_four') == 'yes') {
                        var fifth = ' - ' + $('.del_kpj[val=' + val + ']').closest('tr').children("td:nth-child(5)").html();
                    }
                } else {
            ...
            if (_target == '#modal-delete-selected-kpj') {
                ...
                $('.all_del_kpj').parents('.form-actions').html(text + '<div class="col-md-offset-4 col-md-8"><a href="javascript:void(0)" class="btn btn-red all_del_kpj" val="' + tp + '" take_four="' + fifth + '">Yes &nbsp;<i class="fa fa-check"></i></a> &nbsp;<a href="javascript:void(0)" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a></div>');

                $('.all_del_kpj').click(function () {
                    var model = $(this).attr('val');
                    console.log(_array_del)
                    $.ajax({
                        url: '/admin/action_delete_selected',
                        data: {
                            model: model,
...
<script>
    $(function () {
        $('.savecopyright').click(function (e) {

            $('#copyrightdetail').val($('.copyrightdiv').html());

        });

        $('.saveprivacy').click(function (e) {

            $('#privacydetail').val($('.privacydiv').html());
